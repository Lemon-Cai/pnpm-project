<template>
  <div class="tabs__box">
    <div class="tabs-menu">
      ...
      <!-- 更多操作 -->
      <div class="tab_extra_wrapper flex flex-middle">
        <MoreButton />
        <UserInfo />
        <Logout />
      </div>
...
import UserInfo from '@/page/Layout/components/Header/UserInfo.vue';
import Logout from '@/page/Layout/components/Header/Logout.vue';
